    ...
    <section className="relative w-full">
      <picture>
        ...
        <img
          ...
          className="w-full h-[350px] md:h-[600px] lg:h-[700px] xl:h-[800px] object-cover"
        />
      </picture>
      ...
      <div className="absolute inset-0 pt-[60px]">
        ...
        <div className="hidden md:flex flex-col items-start pl-8 lg:pl-16 xl:pl-24 pt-[30px] lg:pt-[49px] md:ml-[40px] lg:ml-[80px] xl:ml-[100px] md:mt-[60px] lg:mt-[80px] xl:mt-[100px]">
          ...
          ">
            Professional cleaning for homes, offices, and commercial spaces — efficient, safe, and eco-friendly
          </p>
          ...
          >
            ...
            <img src={rightIcon} alt="Right Icon" className="w-[14px] lg:w-[16px] xl:w-[18px] h-auto text-[#031634]" />
          </button>
        </div>
        ...
        <div className="md:hidden flex flex-col items-center text-center px-4 pt-1">
          ...
          <button
            onClick={handleBookNow}
            className="flex items-center gap-[2.66px] w-auto h-[22px] px-2 py-1 bg-white border border-[#031634] rounded-[8px] hover:bg-gray-50 transition-colors duration-200"
          >
