...
import heroDesktop from '../../assets/offices-img.jpg';
import heroMobile from '../../assets/offices-img.jpg';
    ...
    <section className="relative w-full">
      ...
      <div className="absolute inset-0 pt-[60px]">
        ...
        ">
          ...
          ">
            Keep your office spotless and welcoming with services designed for comfort, focus, and health
          </p>
