...
import heroDesktop from '../../assets/contact-img.png';
import heroMobile from '../../assets/contact-img-mobile.png';
      ...
      <div className="absolute inset-0 pt-[60px]">
        ...
        ">
          ...
          <p className="
            ...
            max-w-[320px] lg:max-w-[490px]
          ">
            Get in touch with us to schedule a cleaning or get a free quote.
          </p>
        ...
        <div className="md:hidden flex flex-col items-center text-center px-4 pt-1">
          ...
          <p className="w-[170px] text-[10px] font-quicksand font-medium leading-[100%] text-[#1E1E1E] mb-6">
            Get in touch with us to schedule a cleaning or get a free quote.
          </p>
          <button
            onClick={handleBookNow}
            className="flex items-center gap-[2.66px] w-[100px] h-[22px] px-2 py-1 bg-white border border-[#031634] rounded-[8px] hover:bg-gray-50 transition-colors duration-200 mt-[-10px] mr-3"
          >
